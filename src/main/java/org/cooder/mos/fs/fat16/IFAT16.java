...
public interface IFAT16 extends Closeable {
    ...
    //
    /**
     * @return Value representing the end of the chain. Should be {@code 0xFFF8} for FAT16
     */
    int getEndOfChain();
     ...
     * 
     * @param clusterIdx
     *            簇索引. Data clusters start at 0x0002, and end at 0xFFEF (for FAT16). Special cluster values are:
     *            <ul>
     ...
     * 
     * @param clusterIdx
     *            簇索引. Data clusters start at 0x0002, and end at 0xFFEF. Special cluster values are:
     *            <ul>
     *            <li>0x0000: Free cluster</li>
     *            <li>0xFFF8: Last cluster in file - End Of Chain</li>
     *            </ul>
     * @param valueToWrite
     *            A two-byte value to write into the table.
     */
